...
class Skill extends Component {
    ...
    handleClick(keyName){
    	...
    	if(this.state.hover.endorsed) {
			...
			axios.delete(`http://185.166.107.169:30085/IERIA/skill/${this.props.userData.id}/${keyName}`,
			{
			...
			axios.post(`http://185.166.107.169:30085/IERIA/skill/${this.props.userData.id}/${keyName}/endorse` ,
			{
				"Access-Control-Allow-Origin" : "*"
			})
	    	.then(response => {
