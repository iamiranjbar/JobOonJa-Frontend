...
class Skill extends Component {
    ...
    handleClick(keyName){
    	...
    	if(this.state.hover.endorsed) {
			...
			axios.delete(`http://172.20.255.100:8080/IERIA/skill/${this.props.userData.id}/${keyName}`,
			{
			...
			axios.post(`http://172.20.255.100:8080/IERIA/skill/${this.props.userData.id}/${keyName}/endorse` ,
			{
				"Access-Control-Allow-Origin" : "*"
			})
	    	.then(response => {
